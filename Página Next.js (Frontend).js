...
export default function Home() {
  ...
  const handleExportPDF = async () => {
    ...
    // Estendendo o tipo jsPDF para incluir a função autoTable
    // Esta declaração é necessária para o TypeScript entender o plugin
              ...
              <div>
                ...
                {resposta.total_resultados > 0 && (
                    <div className="mt-6">
                        ...
                        {showPreview && <PreviewTable data={resposta.dados_completos} onExportCSV={handleExportCSV} onExportPDF={handleExportPDF} />}
                    </div>
                )}
              </div>
            )}
